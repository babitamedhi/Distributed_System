...
if __name__ == "__main__":
    # Create two processes with their own Lamport Clocks
    process1 = LamportClock(process_id=1)
    process2 = LamportClock(process_id=2)

    # Simulate events
    process1.send_event()      # Process 1 sends an event
    process2.receive_event(3)  # Process 2 receives an event with timestamp 3
    process2.send_event()      # Process 2 sends an event
    process1.receive_event(4)  # Process 1 receives an event with timestamp 4
